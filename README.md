...
DarkStop — a Flare Confidential Compute (FCC) extension, built from the Hello World scaffold. This repository demonstrates a complete, runnable extension with on-chain contracts, deployment tooling, and registration scripts — everything you need to understand how extensions work on the Flare TEE infrastructure.
...
└── tools/
    ...
    └── pkg/
        ...
        └── contracts/darkstop/
            ├── darkstop.go          # go:generate directive for abigen
...
This repository has been renamed from the Hello World scaffold to DarkStop. The placeholder SAY_HELLO / SAY_GOODBYE logic is still in place and will be replaced with DarkStop's own operations.
